...
\begin{proof}
	...
	By the diagram in \cref{fig:cart-countable}, we let each dot represent on ordered pair who's value is indicated by its row and column.
	\begin{figure}[h]
		\centering
		\adjustbox{max width=0.8\linewidth}{
			\begin{tikzcd}[ampersand replacement=\&,cramped]
				\& 1 \& 2 \& 3 \& \dots \\
				1 \& \bullet \& \bullet \& \bullet \& \dots \\
				2 \& \bullet \& \bullet \\
				3 \& \bullet \\
				\vdots
	...
	\caption{}
	\label{fig:cart-countable}
	\end{figure}
	Following the arrows, we obtain a bijection between $\nat \times \nat \to \nat$.
